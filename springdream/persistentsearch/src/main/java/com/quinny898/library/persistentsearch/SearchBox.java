...
public class SearchBox extends RelativeLayout {
    ...
    /***
     * Reveal the searchbox from a menu item. Specify the menu item id and pass the activity so the item can
     * be found
     *
     * @param id       View ID
    ...
    /***
     * Hide the searchbox using the circle animation which centres upon the provided menu item. Can be called
     * regardless of result list length
     *
    ...
    /***
     * Set whether to search without suggestions being available (default is true). Disable if your app only
     * works with provided options
     *
