...
public class MaterialMenuDrawable extends Drawable implements Animatable {
    ...
    public MaterialMenuDrawable(Context context, int color, Stroke stroke, int transformDuration, int
            pressedDuration) {
        this(context, color, stroke, DEFAULT_SCALE, transformDuration, pressedDuration);
    }

    public MaterialMenuDrawable(Context context, int color, Stroke stroke, int scale, int
    ...
    private MaterialMenuDrawable(int color, Stroke stroke, long transformDuration, long pressedDuration,
                                 int width, int height, float iconWidth, float circleRadius, float
                                         strokeWidth, float dip1
    ) {
        this.dip1 = dip1;
        this.dip2 = dip1 * 2;
        this.dip3 = dip1 * 3;
    ...
    private void drawBottomLine(Canvas canvas, float ratio) {
        ...
        switch (animationState) {
            ...
            case X_CHECK:
                ...
                rotation = X_BOT_LINE_ANGLE + (CHECK_BOTTOM_ANGLE + ARROW_TOP_LINE_ANGLE -
                        X_BOT_LINE_ANGLE) * ratio;
