...
public class CategoryDao extends AbstractDao<Category, Long> {
    ...
    protected void bindValues(SQLiteStatement stmt, Category entity) {
        ...
        Short sequence = entity.getSequence();
        if (sequence != null) {
    ...
    public Category readEntity(Cursor cursor, int offset) {
        Category entity = new Category( //
                ...
                cursor.isNull(offset + 4) ? null : cursor.getShort(offset + 4), // sequence
    ...
    public void readEntity(Cursor cursor, Category entity, int offset) {
        ...
        entity.setSequence(cursor.isNull(offset + 4) ? null : cursor.getShort(offset + 4));
    ...
    /**
     * Properties of entity Category.<br/> Can be used for QueryBuilder and for referencing column names.
     */
    public static class Properties {
        ...
        public final static Property Sequence = new Property(4, Short.class, "sequence", false, "SEQUENCE");
